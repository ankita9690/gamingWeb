...
function animateSprite() {
  ...
  if (
    // sprite falls out of game area
    spriteTop > gameHeight - spriteHeight ||
    // sprite collides with block
    // x position of right side of sprite greater than x position of left side of block
    (spriteLeft + spriteWidth > blockLeft &&
      // y position of sprite not same as y position of hole
      // (so it has hit the block, not the hole)
